		...
		return { //this:ActionBasciFsm
				...
				state("work") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t056",targetState="exposeState",cond=whenDispatch("consult"))
					transition(edgeName="t057",targetState="handleChangeState",cond=whenDispatch("changeState"))
				}	 
