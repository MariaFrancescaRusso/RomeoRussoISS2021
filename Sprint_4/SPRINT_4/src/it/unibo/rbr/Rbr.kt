		...
		return { //this:ActionBasciFsm
				...
				state("mapping") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t016",targetState="working",cond=whenReply("mapdone"))
				}	 
				state("working") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t117",targetState="exPrepareHP",cond=whenDispatch("prepare"))
				}	 
				state("exPrepareHP") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t218",targetState="exPreparePT",cond=whenReply("goalState"))
				}	 
				state("exPreparePT") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t319",targetState="exPrepareTF",cond=whenReply("goalState"))
				}	 
				state("exPrepareTF") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t420",targetState="exPrepareFT",cond=whenReply("goalState"))
				}	 
				state("exPrepareFT") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t521",targetState="addFoodTable",cond=whenReply("goalState"))
				}	 
				...
				state("goToHome") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t622",targetState="wait",cond=whenReplyGuarded("goalState",{ !Cleared  
					}))
					transition(edgeName="t623",targetState="terminateRbr",cond=whenReplyGuarded("goalState",{ Cleared  
					}))
				}	 
				state("wait") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t724",targetState="checkFood",cond=whenRequest("addFood"))
					transition(edgeName="t725",targetState="exClearHT",cond=whenDispatch("clear"))
				}	 
				state("checkFood") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t826",targetState="handleAnswer",cond=whenEvent("observerfridge"))
				}	 
				...
				state("waitAnswer") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t927",targetState="handleAnswer",cond=whenEvent("observerfridge"))
				}	 
				...
				state("exAddFoodHF") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t1028",targetState="exAddFoodFT",cond=whenReply("goalState"))
				}	 
				state("exAddFoodFT") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t1129",targetState="addFoodTable",cond=whenReply("goalState"))
				}	 
				state("exClearHT") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t1230",targetState="exClearTF",cond=whenReplyGuarded("goalState",{ Food != "[]"  
					}))
					transition(edgeName="t1231",targetState="exClearTD",cond=whenReplyGuarded("goalState",{ Food == "[]"  
					}))
				}	 
				state("exClearTF") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t1332",targetState="exClearFT",cond=whenReply("goalState"))
				}	 
				state("exClearFT") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t1433",targetState="exClearTD",cond=whenReply("goalState"))
				}	 
				state("exClearTD") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t1534",targetState="exClearD",cond=whenReply("goalState"))
				}	 
