		...
		return { //this:ActionBasciFsm
				...
				state("work") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t018",targetState="exposeState",cond=whenDispatch("consult"))
					transition(edgeName="t019",targetState="handleChangeState",cond=whenDispatch("changeState"))
				}	 
