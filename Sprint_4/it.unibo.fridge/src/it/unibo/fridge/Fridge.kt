		...
		return { //this:ActionBasciFsm
				...
				state("wait") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t10",targetState="answerFood",cond=whenDispatch("askFood"))
					transition(edgeName="t11",targetState="exposeState",cond=whenDispatch("consult"))
					transition(edgeName="t12",targetState="handleChangeState",cond=whenDispatch("changeState"))
				}	 
