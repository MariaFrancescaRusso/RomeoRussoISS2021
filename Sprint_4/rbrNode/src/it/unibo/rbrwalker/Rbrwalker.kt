		...
		return { //this:ActionBasciFsm
				...
				state("wait") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t027",targetState="wait",cond=whenRequestGuarded("stop",{ itunibo.planner.plannerUtil.atHome()  
					}))
				...
				state("doTurn") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t232",targetState="goToGoal",cond=whenTimeout("local_tout_rbrwalker_doTurn"))   
					transition(edgeName="t233",targetState="handleStop",cond=whenRequest("stop"))
				}	 
				state("handleAnswer") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t334",targetState="handleFail",cond=whenTimeout("local_tout_rbrwalker_handleAnswer"))   
					transition(edgeName="t335",targetState="handleStop",cond=whenRequest("stop"))
				}	 
				...
				state("handleStop") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t436",targetState="doStep",cond=whenDispatchGuarded("reactivate",{ ObstGoal  
					}))
					transition(edgeName="t437",targetState="goToGoal",cond=whenDispatchGuarded("reactivate",{ !ObstGoal  
					}))
				}	 
