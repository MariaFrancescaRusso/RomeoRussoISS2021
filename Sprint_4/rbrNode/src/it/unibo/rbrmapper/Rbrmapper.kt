		...
		return { //this:ActionBasciFsm
				...
				state("obstacleFound") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t323",targetState="turnLeft",cond=whenReplyGuarded("stepdone",{ !Table  
					}))
					transition(edgeName="t324",targetState="tableFound",cond=whenReplyGuarded("stepdone",{ Table  
					}))
				...
				state("turnHome") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t426",targetState="endState",cond=whenReply("goalState"))
				}	 
