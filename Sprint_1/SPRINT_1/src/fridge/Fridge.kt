		...
		return { //this:ActionBasciFsm
				...
				state("wait") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t121",targetState="answerFood",cond=whenDispatch("askFood"))
					transition(edgeName="t122",targetState="exposeState",cond=whenDispatch("consult"))
					transition(edgeName="t123",targetState="handleChangeState",cond=whenDispatch("changeState"))
				}	 
