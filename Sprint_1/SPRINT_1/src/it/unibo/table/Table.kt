		...
		return { //this:ActionBasciFsm
				...
				state("work") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t022",targetState="exposeState",cond=whenDispatch("consult"))
					transition(edgeName="t023",targetState="handleChangeState",cond=whenDispatch("changeState"))
				}	 
