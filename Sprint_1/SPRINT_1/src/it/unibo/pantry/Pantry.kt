		...
		return { //this:ActionBasciFsm
				...
				state("work") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t020",targetState="exposeState",cond=whenDispatch("consult"))
					transition(edgeName="t021",targetState="handleChangeState",cond=whenDispatch("changeState"))
				}	 
