		...
		return { //this:ActionBasciFsm
				...
				state("work") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t016",targetState="exposeState",cond=whenDispatch("consult"))
					transition(edgeName="t017",targetState="handleChangeState",cond=whenDispatch("changeState"))
				}	 
