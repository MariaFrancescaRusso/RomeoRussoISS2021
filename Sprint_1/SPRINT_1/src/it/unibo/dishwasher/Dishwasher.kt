		...
		return { //this:ActionBasciFsm
				...
				state("work") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t033",targetState="exposeState",cond=whenDispatch("consult"))
					transition(edgeName="t034",targetState="handleChangeState",cond=whenDispatch("changeState"))
				}	 
