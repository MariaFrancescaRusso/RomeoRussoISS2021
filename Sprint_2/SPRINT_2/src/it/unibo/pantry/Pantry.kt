		...
		return { //this:ActionBasciFsm
				...
				state("work") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t032",targetState="exposeState",cond=whenDispatch("consult"))
					transition(edgeName="t033",targetState="handleChangeState",cond=whenDispatch("changeState"))
				}	 
