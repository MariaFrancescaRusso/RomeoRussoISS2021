		...
		return { //this:ActionBasciFsm
				...
				state("work") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t046",targetState="exposeState",cond=whenDispatch("consult"))
					transition(edgeName="t047",targetState="handleChangeState",cond=whenDispatch("changeState"))
				}	 
